...
impl From<ethjson::spec::MAuraParams> for MAuraParams {
	fn from(p: ethjson::spec::MAuraParams) -> Self {
...
/// Engine using `MAura` proof-of-authority BFT consensus.
pub struct MAura {
...
impl MAura {
	/// Create a new instance of MAura engine.
	pub fn new(our_params: MAuraParams, machine: EthereumMachine) -> Result<Arc<Self>, Error> {
...
impl Engine<EthereumMachine> for MAura {
	fn name(&self) -> &str { "MyAuthorityRound" }
